...
This feature is only enabled in *live environment* and must be set up manually - following two lines have to be added at the top of root `.htaccess` file in order for it to work:
```.apacheconf
# BEGIN BC Security
# END BC Security
```
