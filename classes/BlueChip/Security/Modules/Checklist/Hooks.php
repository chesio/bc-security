...
interface Hooks
{
     ...
     */
    public const ADVANCED_CHECK_ALERT = 'bc-security/action:checklist-advanced-check-alert';

    /**
     * Action: triggers when any of basic checks does not pass during checklist monitoring run.
     */
    public const BASIC_CHECKS_ALERT = 'bc-security/action:checklist-basic-checks-alert';
     ...
     * }, 10, 1);
     */
    public const OBVIOUS_USERNAMES = 'bc-security/filter:obvious-usernames';

    /**
     * Filter: filters list of files that should be ignored during check for modified core files.
     */
    public const IGNORED_CORE_MODIFIED_FILES = 'bc-security/filter:modified-files-ignored-in-core-integrity-check';

    /**
     * Filter: filters list of files that should be ignored during check for unknown core files.
     */
    public const IGNORED_CORE_UNKNOWN_FILES = 'bc-security/filter:unknown-files-ignored-in-core-integrity-check';

    /**
     * Filter: filters list of plugins to check in integrity check.
     */
    public const PLUGINS_TO_CHECK_FOR_INTEGRITY = 'bc-security/filter:plugins-to-check-for-integrity';

    /**
     * Filter: allows to filter list of plugins that are checked for removal from Plugins Directory at WordPress.org.
     */
    public const PLUGINS_TO_CHECK_FOR_REMOVAL = 'bc-security/filter:plugins-to-check-for-removal';
}
