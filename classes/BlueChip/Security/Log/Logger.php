...
namespace BlueChip\Security\Log;

use BlueChip\Security\Core\Module;
use Psr\Log;
 ...
 */
class Logger extends Log\AbstractLogger implements Log\LoggerInterface, Module\Installable, Module\Loadable
{
